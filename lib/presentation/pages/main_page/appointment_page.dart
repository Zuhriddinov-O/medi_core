          ...
          child: SizedBox(
            ...
            child: CupertinoSlidingSegmentedControl(
              ...
              onValueChanged: (int? newValue) {
                page.animateToPage(newValue!, duration: const Duration(milliseconds: 350), curve: Curves.fastOutSlowIn);
                setState(() {
                  _sliding = newValue;
                });
              },
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: 14, color: Color(0xFF074CFF)),
                    ),
                  ],
                ),
              )
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      "Monday, 26th september, 9:00 - 10:00",
                      style: TextStyle(fontSize: 14, color: Color(0xFFFD7062)),
                    ),
                  ],
                ),
              )
